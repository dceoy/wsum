...
A dependency-free deterministic toolkit and Agent Skill for weekly website change
monitoring. It reads configuration/state through Google Sheets connectors, fetches
